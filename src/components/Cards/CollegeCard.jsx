        ...
        <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col group overflow-hidden border border-gray-100 h-full">
            ...
            <div className="h-56 md:h-64 w-full overflow-hidden relative">
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-2">
                    <div className="bg-secondary text-white text-[10px] font-black px-3 py-1 rounded-md uppercase tracking-widest shadow-lg">
                        Admission Open
                    </div>
                    <div className="bg-white/90 backdrop-blur-sm text-primary text-[10px] font-black px-3 py-1 rounded-md uppercase flex items-center gap-1 shadow-lg">
            ...
            <div className="p-8 flex flex-col flex-grow">
                <h2 className="text-2xl font-black text-primary mb-4 truncate group-hover:text-secondary transition-colors" title={college_name}>
                    {college_name}
                </h2>
                    ...
                    <div className="flex justify-between items-center text-xs border-b border-gray-50 pb-4">
                        <div className="flex flex-col gap-1">
                            ...
                            <span className="text-primary font-black flex items-center gap-2">
                                <FaFlask className="text-secondary" /> {number_of_research}+ Papers
                            </span>
                        </div>
                        <div className="text-right flex flex-col gap-1">
                            <span className="text-gray-400 font-bold uppercase tracking-wider">Deadline</span>
                            <span className="text-primary font-black flex items-center justify-end gap-2">
                                <FaCalendarAlt className="text-secondary" /> {admission_date}
                            </span>
                        </div>
                    </div>
                ...
                <div className="mt-auto">
                    <Link to={`/allColleges/${college?._id}`} className="w-full">
                        <button className="relative w-full inline-flex items-center justify-center px-10 py-4 overflow-hidden font-black text-primary transition duration-500 ease-out border-2 border-primary shadow-sm group/btn rounded-2xl hover:text-white">
