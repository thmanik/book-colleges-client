    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-4 sm:px-10 md:px-20 py-10 md:py-20 bg-white overflow-hidden">
            ...
            <div className="order-1 md:order-2 flex flex-col space-y-5 text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start gap-2 text-[#FF7350] text-xl md:text-3xl font-black italic">
                    <FaGraduationCap />
                    <span>About Us</span>
                </div>
                ...
                <div className="space-y-4">
                    <p className="text-base md:text-xl text-[#014C63] leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 pt-4">
                    <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                        <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
                            <span className="bg-[#FF7350] text-white px-3 py-1 rounded-full font-bold text-sm">01</span>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                        <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
                            <span className="bg-[#FF7350] text-white px-3 py-1 rounded-full font-bold text-sm">02</span>
                            <h2 className="text-lg font-bold">Reputed College</h2>
                        </div>
                        <p className="text-gray-500 text-sm">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit?
                ...
                <div className="pt-4 flex justify-center md:justify-start">
                    <button className="btn-color relative inline-flex items-center justify-center px-10 py-3 overflow-hidden font-medium text-blue-700 transition duration-400 border-2 rounded-full shadow-md group">
                        <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full group-hover:translate-x-0 ease">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                            </svg>
                        </span>
                        <span className="absolute flex items-center justify-center w-full h-full transition-all duration-300 transform group-hover:translate-x-full ease font-bold">
                            Read More
                        </span>
                        <span className="relative invisible font-bold">Read More</span>
                    </button>
                </div>
            </div>
        </div>
