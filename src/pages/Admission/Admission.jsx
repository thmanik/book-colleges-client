        ...
        <div className="bg-[#F8FAFC] min-h-screen pb-20 font-sans">
            ...
            <div className="bg-white border-b border-gray-100 pt-16 pb-12 px-6">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-center md:text-left">
                        <div className="flex items-center justify-center md:justify-start gap-2 text-primary font-bold uppercase tracking-widest text-xs mb-3">
                            <span className="w-8 h-[2px] bg-secondary"></span>
                            Academic Year 2024-25
                        </div>
                        <h1 className="text-4xl md:text-5xl font-black text-primary leading-tight">
                            College <span className="text-secondary">Admission</span> Listing
                        </h1>
                    ...
                    <div className="bg-primary rounded-2xl p-6 text-white shadow-xl shadow-blue-900/10 flex items-center gap-6">
                    ...
                    {collegesInfo.map((college, index) => (
                        ...
                        >
                            <div className="flex items-center gap-6 w-full md:w-auto">
                                ...
                                <div className="hidden sm:flex items-center justify-center w-12 h-12 rounded-xl bg-gray-100 text-gray-500 font-bold group-hover:bg-primary group-hover:text-white transition-colors">
                                    {index + 1}
                                </div>
                                
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-orange-50 flex items-center justify-center text-secondary border border-orange-100">
                            ...
                            <div className="flex items-center gap-6 w-full md:w-auto mt-6 md:mt-0 border-t md:border-t-0 pt-4 md:pt-0">
                                ...
                                <Link 
                                    ...
                                    className="w-full md:w-auto flex items-center justify-center gap-3 bg-primary hover:bg-secondary text-white font-bold px-8 py-3.5 rounded-xl transition-all duration-300 shadow-lg shadow-blue-900/10 active:scale-95"
                                >
            ...
            <div className="max-w-6xl mx-auto px-6 mt-16 text-center">
                <p className="text-gray-400 text-sm">
                    Having trouble with the application? <a href="#" className="text-primary font-bold border-b-2 border-orange-200 hover:border-secondary transition-all">Download Admission Guide (PDF)</a>
                </p>
            </div>
        </div>
    );
